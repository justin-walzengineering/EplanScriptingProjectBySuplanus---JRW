...
// * SetCursorColor
// *
// * Customize cursor color for each EPLAN color scheme.
// *
// * ~~~~~~~~~~~~~~~~~ Changelog ~~~~~~~~~~~~~~~~
// * 2011-07-18 Nairolf program creation
// * 2011-08-07 Jonny Wire extension to GUI
// * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//* /
...
public partial class frmSetCursorColor : System.Windows.Forms.Form
{
    ...
    private void frmSetCursorColor_FormClosed(object sender, FormClosedEventArgs e)
    {
        ...
        if (bColorChanged)
        {
            MessageBox.Show("Cursor color scheme changed. \n "
            + "EPLAN must be restarted for the new setting to be adopted.",
    ...
    public void MenuFunction()
    {
        ...
        oMenu.AddMenuItem
            ...
            "Set cursor color...",
            "SetCursorColor",
            "Set cursor color for different color scheme",
            35178,
            1,
            false,
            false
