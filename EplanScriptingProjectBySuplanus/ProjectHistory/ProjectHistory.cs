...
public class FrmProjectHistory : System.Windows.Forms.Form
{
    ...
    // Form (program files for generating the form)
    #region Form
    ...
    //
    // True, when managed resources to be deleted; otherwise False.
    ...
    private void InitializeComponent()
    {
        ...
        this.lblStatus2.Text = "Last change: 2018-2-19  - Justin Walz";
        // 
        // statusStrip1
        // 
        ...
        this.btnProjectsHistory.Text = "Open project(s)";
        ...
        this.btnHistory.Text = "History clear";
    ...
    private void btnOpenProject_Click(object sender, System.EventArgs e)
    {
        ...
        openFileDlg.Filter = "Project file (*.el*)|*.el*|Show all files| *.*";
    ...
    // Method: Eplan Action: ProjectOpen
